...
2026-09-07 부터 portfolio.py 기본값이 전체 이력 패널(panel_*.pkl · 지수 2004 · 자사주 2004)이라
환경변수 없이 돌려도 된다. 옛 운영 패널로 보려면 PANEL_KP=kp_ow.pkl PANEL_KQ=kq_ow.pkl IX_FROM=2017-01-01.
사용: python hist_portfolio.py [--seeds 12]
"""
...
# 2026-09-07 기준 구간: 학습 2016~22 · 검증 2023~26 · 2005~15 는 스트레스 참고. 옛 세부 구간도 남겨 둔다.
PER = [("2005~2007","20050101","20071231"), ("2008~2009 위기","20080101","20091231"),
       ("2010~2012","20100101","20121231"), ("2013~2015","20130101","20151231"),
       ("스트레스 2005~15","20050101","20151231"),
       ("학습 2016~2022","20160101","20221231"), ("검증 2023~2026","20230101","20991231"),
       ("기준 2016~","20160101","20991231"), ("전체 2005~","20050101","20991231")]
